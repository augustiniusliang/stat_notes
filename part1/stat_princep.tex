...
正如在正则系综中，我们对于逸度求导可以得到平均能量一样，我们现在也可以通过对巨配分函数的求导得到巨正则分布的特征参量，就是\textbf{平均占有数。}具体来说，我们设参量 \[\alpha = -\frac\mu {k_BT},\] 那么平均占有数就可以写成 \[ \bar N = \tr\left( \hat\rho \hat N \right) = \frac1\Xi \sum_iN_i \exp\left( \alpha N_i-\beta E_i \right) = -\frac{\partial \Xi}{\Xi\partial \alpha}.\] 注意，平均能量的求法和正则系综一样。
